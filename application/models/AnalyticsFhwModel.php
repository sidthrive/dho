...
class AnalyticsFhwModel extends CI_Model{
    ...
    private $listdusun = ['user1'=>array("Lekor+Timur"=>"Lekor Timur","Lekor+Barat"=>"Lekor Barat","Sondo"=>"Sondo","Gulung"=>"Gulung","Pepao+Timur"=>"Pepao Timur","Lengkok+Bunut"=>"Lengkok Bunut","Lendang+Jawe"=>"Lendang Jawe","Pepao+Barat+I"=>"Pepao Barat I","Presak"=>"Presak","Taken-Aken"=>"Taken Aken","Pepao+Barat+II"=>"Pepao Barat II","Renge"=>"Renge","Pelapak"=>"Pelapak","Walun"=>"Walun","Montong+Bile"=>"Montong Bile","Lainnya"=>"Lainnya")
                        ...
                        ,'user3'=>array("Montor"=>"Montor","Pendem"=>"Pendem","Piling"=>"Piling","Maliklo"=>"Maliklo","Jelitong"=>"Jelitong","Karang+Majelo"=>"Karang Majelo","Penuntut"=>"Penuntut","Kuang"=>"Kuang","Jangka"=>"Jangka","Petorok"=>"Petorok","Gelung"=>"Gelung","Gelondong"=>"Gelondong","Nyangget"=>"Nyangget","Montong+Bile"=>"Montong Bile","Lekong+Bangkon"=>"Lekong Bangkon")
                        ,'user4'=>array("Juna"=>"Juna","Nunang"=>"Nunang","Batu+Belek"=>"Batu Belek","Siwi"=>"Siwi","Setuta+Barat"=>"Setuta Barat","Setuta+Timur"=>"Setuta Timur","Liwung"=>"Liwung","Liwung_Selatan"=>"Liwung Selatan","Biletawah"=>"Biletawah","Liwung+Satu"=>"Liwung Satu","Liwung+Dua"=>"Liwung Dua","Nunang+Selatan"=>"Nunang Selatan")

<div id="page" class="container">
    ...
    <div id="sidebar1">
        ...
        <div class="panel-group" id="accordion">
            ...
            <?php } ?>
            <?php if($this->session->userdata('tipe')=="bidan"||$this->session->userdata('tipe')=="all"){ ?>
            <div class="panel panel-default" id="gens">
                <a href="<?php echo site_url() ."laporan/gen"?>">
                <div class="panel-heading" <?=($this->uri->segment(2)=='gen')?' style="background-color:#909090"':''?>>
                    <h4 class="panel-title">
                        Gen
                    </h4>
                </div>
            ...
            <div class="panel panel-default" id="karanas">
                <a href="<?php echo site_url() ."laporan/karana"?>">
                <div class="panel-heading" <?=($this->uri->segment(2)=='karana')?' style="background-color:#909090"':''?>>
                    <h4 class="panel-title">
                        Karana
                    </h4>
                </div>

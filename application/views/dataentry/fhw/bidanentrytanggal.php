<?php
    ...
    if($a!="Mingguan"&&$a!="Bulanan"&&$a!=null){
        $url = "dataentry/getfhwbidanByForm/";
    }
    else {
        $url = "dataentry/getbidanByForm/";
    }
?>    
    <div id="content">
        <div id="text">
        ...
        <div>
            ...
            <form class="form" action="<?php echo site_url()."dataentry/bidanbytanggal/"?>" method="get">
            <?php }else{ ?>
            <form class="form" action="<?php echo site_url()."dataentry/bidanbytanggal/".$kecamatan."/".$desa?>" method="get">
            <?php } ?>

...
?>    
    <div id="content">
        ...
        <div>
            ...
            <form class="form" action="<?php echo site_url()."dataentry/gizibytanggal/"?>" method="get">
            <?php }else{ ?>
            <form class="form" action="<?php echo site_url()."dataentry/gizibytanggal/".$kecamatan."/".$desa?>" method="get">
            <?php } ?>
    ...
    $( "select" ).change(function() {
        $( "select option:selected" ).each(function() {
            ...
            if(mode!=newmode){
                ...
                window.location.href = "<?=base_url()."dataentry/gizibytanggal/".$kecamatan."/".$desa?>"+modeurl;                    
                <?php }else{?>
                window.location.href = "<?=base_url()."dataentry/gizibytanggal/".$desa?>"+modeurl;
                <?php }?>
            }
